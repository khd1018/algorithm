...
while True:
    ...
    # 무한 루프 돌것 같더라..
    if n_row < 0 or n_column < 0 or n_row > n or n_column > m or game_map[n_row][n_column] == 2 or game_map[n_row][n_column] == 1:
        n_row = row
        n_column = column
        continue

    # 네방향 모두 가본 칸 or 바다인 경우,,,
